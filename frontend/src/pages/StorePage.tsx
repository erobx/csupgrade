      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="flex justify-start ml-4">
          <div className="flex gap-6">
            <Crate crateId="1" name="Series Zero Core" amount={3} />
            <Crate crateId="" name="Series Zero Prime" amount={3} />
            <Crate crateId="" name="Series Zero Prototype" amount={3} />
          </div>
        </div>
        ...
        <div className="flex justify-start ml-4">
          <div className="flex gap-6">
            <Crate crateId="" name="Consumer Pack" amount={5} />
            <Crate crateId="" name="Industrial Pack" amount={5} />
            <Crate crateId="" name="Mil-Spec Pack" amount={5} />
          </div>
        </div>
